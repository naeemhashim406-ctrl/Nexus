  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <StaggerContainer
          staggerDelay={0.12}
          className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8 sm:gap-8 lg:gap-0 lg:divide-x lg:divide-[#0B1F4D]/10"
        >
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 mb-2 max-w-full">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#5BB8F5]/15 flex items-center justify-center text-[#1F4FA3] flex-shrink-0 transition-transform duration-300 hover:scale-110">
