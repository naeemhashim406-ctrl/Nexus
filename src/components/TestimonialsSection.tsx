        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2.5 sm:p-3 rounded-full border border-[#0B1F4D]/15 text-[#0B1F4D] hover:bg-[#0B1F4D] hover:text-white transition-all shadow-sm"
            >
          ...
          >
            {reviews.map((rev) => (
              <div key={rev.id} className="w-full flex-shrink-0 px-1 sm:px-4">
                <div className="max-w-4xl mx-auto p-5 sm:p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[#F4F8FD] to-[#FFFFFF] border border-[#0B1F4D]/8 shadow-[0_10px_35px_rgba(11,31,77,0.04)] relative">
