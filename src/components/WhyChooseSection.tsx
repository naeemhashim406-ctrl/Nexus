        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {SITE_CONFIG.strengths.map((item) => (
              <div
                key={item.number}
                className="group p-5 sm:p-6 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-[#5BB8F5]/40 backdrop-blur-md transition-all duration-300 flex flex-col justify-between min-w-0"
              >
                <div>
